...
const inputUser2 = document.querySelector('.form-register input[type="text2"]');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  inputUser2.addEventListener("input", () => {
    validarCampo(userNameRegex,inputUser2,"El usuario tiene que ser de 4 a 16 dígitos y solo puede contener, letras y guión bajo.");
  });
...
export function enviarFormulario(form, alertaError,alertaExito) {
  ...
  if (estadoValidacionCampos.txtNombresR && estadoValidacionCampos.txtApellidosR && estadoValidacionCampos.txtUsuarioR && estadoValidacionCampos.txtContraseniaR) {
    
    form.submit();
    
    //Se agregó estas 4 líneas de código que evitan un error al mostrar las alertas , lo que hacen es resetear los valores del objeto
    estadoValidacionCampos.txtNombresR = false;
    estadoValidacionCampos.txtApellidosR = false;
    estadoValidacionCampos.txtUsuarioR = false;
    estadoValidacionCampos.txtContraseniaR = false;
